...
class GRectangle(GObject):
    """
    An instance represents a (potentially) solid rectangle.
...
class GEllipse(GRectangle):
    """
    An instance represents a solid ellipse.
...
class GImage(GRectangle):
    """
    An instance represents a rectangular image.
...
class GLabel(GRectangle):
    """
    An instance represents an (uneditable) text label
    ...
    def __init__(self,**keywords):
        ...
        sanitized = {}
        excludes  = ['linewidth','linecolor','fillcolor','halign','valign']
        for key in keywords:
