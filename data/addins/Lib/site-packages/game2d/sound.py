...
class Sound(object):
    """
    An instance is a sound object that can be played.
...
class SoundLibrary(object):
    """
    An instance is a dictionary that maps sounds to Sound objects.
    ...
    def __getitem__(self, key):
        """
        Access the sound object for the given name.
    ...
    def __setitem__(self, key, filename):
        ...
        :type filename:  ``str``
        """
        assert is_sound_file(filename), repr(filename)+' is not a sound file'
    ...
    def iterkeys(self):
        """
        :return: The key iterator for this sound dictionary.
        :rtype:  ``iterable``
        """
        return self._data.iterkeys()
